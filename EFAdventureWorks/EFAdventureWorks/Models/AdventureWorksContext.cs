...
namespace EFAdventureWorks.Models
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=localhost, 1444;Initial Catalog=AdventureWorks;User ID=sa;Password=P@ssw0rd!");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<JobCandidate>(entity =>
            {
                ...
                entity.HasComment("R?sum?s submitted to Human Resources by job applicants.");
                ...
                entity.Property(e => e.Resume)
                    .HasColumnType("xml")
                    .HasComment("R?sum? in XML format.");
            ...
            modelBuilder.Entity<SalesOrderDetail>(entity =>
            {
                ...
                entity.OwnsOne(
                    ...
                    productId =>
                    {
                        productId.Property(x => x.Value).HasColumnName("ProductID");
                    });
